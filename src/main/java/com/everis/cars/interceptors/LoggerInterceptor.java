...
/**
 * This class is only responsible of log the start and ending of the intercepted
 * methods and doesn't modify any functionality of this methods.
 */
public class LoggerInterceptor {
	...
	/**
	 * Around method to intercept and log the runtime methods intercepted by
	 * the @Interceptors annotations. It doesn't alter the
	 * {@link javax.interceptor.InvocationContext.proceed()} return.
	 * 
