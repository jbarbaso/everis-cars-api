...
/**
 * ExceptionMapper to catch NotAllowedException exceptions and standardize
 * exception responses
 */
@Provider
public class NotAllowedExceptionMapper implements ExceptionMapper<NotAllowedException> {
	...
	/**
	 * Override the default toResponse method to catch {@link NotAllowedException}
	 * and format it as a {@link ErrorMessageCollection}.
	 * <p>
	 * This method will send a 405 status code and the
	 * {@link ErrorMessageCollection} when a request at REST layer is not allowed in
	 * the system.
	 * </p>
	 * .
	 * 
	 * @param exception the {@link NotAllowedException} given to be formatted
	 * @return response with 405 status code and {@link ErrorMessageCollection}
	 *         object
	...
	public Response toResponse(NotAllowedException exception) {
		...
		return Response.status(Status.METHOD_NOT_ALLOWED).entity(errors).build();
	}
