...
/**
 * ExceptionMapper to catch Bean Validation exceptions and standardize exception
 * responses
 */
@Provider
...
public class BeanValConstrainViolationExceptionMapper implements ExceptionMapper<ConstraintViolationException> {
	...
	/**
	 * Override the default toResponse method to catch the bean validation errors
	 * from {@link ConstraintViolationException} and format it as a
	 * {@link ErrorMessageCollection}.
	 * <p>
	 * This method will send a 400 status code and the
	 * {@link ErrorMessageCollection} when object given from REST layer fail on bean
	 * validations
	 * </p>
	 * .
	 * 
	 * @param exception the {@link ConstraintViolationException} given to construct
	 *                  the response
	...
	/**
	 * Prepare {@link ErrorMessageCollection} and transform the
	 * {@link ConstraintViolationException} messages to {@link ErrorMessage} format.
	 * 
	 * @param exception the {@link ConstraintViolationException} to be formatted
	 * @return errors {@link ErrorMessageCollection} with {@link ErrorMessage} added
	 *         from {@link ConstraintViolationException}
	 */
